...
public class NeuralNetwork3 {
	...
	// 分配訓練資料
	public static void assignTranMatrix(NeuralNetwork3 neuralNetwork) {
		int x = 0, y = 0;
	...
	// 分配測試資料
	public static void assignTestMatrix(NeuralNetwork3 neuralNetwork) {
		int x = 0, y = 0;
	...
	// 正規化
	public static void normalization(NeuralNetwork3 neuralNetwork) {
		// 訓練資料
	...
	// 取得期望值
	public static void trainingExceptValue(NeuralNetwork3 neuralNetwork) {
	...
	public static void layer2(NeuralNetwork3 neuralNetwork) {
		int a, b;
		for (int i = 0; i < neuralNetwork.tranX; i++) {
			for (int j = 0; j < neuralNetwork.tranY; j++) {
	...
	public static void layer3(NeuralNetwork3 neuralNetwork) {

	}
	
	public static void backwardW3(NeuralNetwork3 neuralNetwork) {

	}
	
	public static void backwardD2(NeuralNetwork3 neuralNetwork) {

	}

	public static void backwardW2(NeuralNetwork3 neuralNetwork) {

	}

	public static void backwardD1(NeuralNetwork3 neuralNetwork) {

	}

	public static void backwardW1(NeuralNetwork3 neuralNetwork) {
