...
public class NeuralNetwork4 {
	...
	// 分配訓練資料
	public static void assignTranMatrix(NeuralNetwork4 neuralNetwork) {
		int x = 0, y = 0;
	...
	// 分配測試資料
	public static void assignTestMatrix(NeuralNetwork4 neuralNetwork) {
		int x = 0, y = 0;
	...
	// 正規化
	public static void normalization(NeuralNetwork4 neuralNetwork) {
		// 訓練資料
	...
	// 取得期望值
	public static void trainingExceptValue(NeuralNetwork4 neuralNetwork) {
	...
	public static void layer2(NeuralNetwork4 neuralNetwork) {
		int a, b;
		for (int i = 0; i < neuralNetwork.tranX; i++) {
			for (int j = 0; j < neuralNetwork.tranY; j++) {
	...
	public static void layer3(NeuralNetwork4 neuralNetwork) {

	}
	
	public static void layer4(NeuralNetwork4 neuralNetwork) {

	}
	
	public static void backwardW3(NeuralNetwork4 neuralNetwork) {

	}
	
	public static void backwardD2(NeuralNetwork4 neuralNetwork) {

	}

	public static void backwardW2(NeuralNetwork4 neuralNetwork) {

	}

	public static void backwardD1(NeuralNetwork4 neuralNetwork) {

	}

	public static void backwardW1(NeuralNetwork4 neuralNetwork) {
